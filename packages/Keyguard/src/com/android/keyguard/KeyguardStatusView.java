...
import com.android.internal.util.slim.WeatherController;
import com.android.internal.util.slim.WeatherControllerImpl;
import com.android.internal.util.slim.WeatherImageHelper;
    ...
    private void updateWeatherSettings(boolean forceHide) {
        ...
        if (iconNameValue == 0 || colorizeAllIcons) {
            Bitmap coloredWeatherIcon =
                    WeatherImageHelper.getColoredBitmap(weatherIcon, iconColor);
